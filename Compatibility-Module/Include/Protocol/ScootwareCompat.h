#ifndef __SCOOTWARE_COMPAT_H__
#define __SCOOTWARE_COMPAT_H__
...
//
// Scootware Compatibility Module Protocol GUID
//
...
typedef enum _EFIGUARD_DSE_BYPASS_TYPE {
	...
	//
	// Auto-detect: the loader resolves this to AtBoot or SetVariableHook based on the
	// host OS build number at boot time.  This is the recommended setting for most users.
	//
	DSE_DISABLE_AUTO = 3
...
//
#define EFIGUARD_BACKDOOR_VARIABLE_NAME						L"roodkcaBdrauGifE" // "ScootwareCompatBackdoor" // TODO: randomize?
...
//
// The ScootwareCompat bootkit driver protocol.
//
