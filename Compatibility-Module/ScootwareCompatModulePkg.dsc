[Defines]
  PLATFORM_NAME                  = ScootwareCompatModule
  PLATFORM_GUID                  = C5ACE17D-FD90-44F7-847C-693ED2B8BEF9
  PLATFORM_VERSION               = 1.00
  DSC_SPECIFICATION              = 0x0001001B
  OUTPUT_DIRECTORY               = Build/ScootwareCompatModule
...
[Components]
  # DXE driver
  ScootwareCompatModulePkg/EfiGuardDxe/ScootwareCompatDxe.inf

  # Loader application
  ScootwareCompatModulePkg/Application/Loader/Loader.inf
